...
const handleLogout = async () => {
  ...
  return (
    <div className='w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex  items-center justify-between px-[10px] shadow-md shadow-black '>
     ...
     <div className="flex items-center gap-2 md:gap-6 lg:gap-2 px-4">
  <img src={logo} alt="GS Fashion Logo" className="w-16 md:w-20 lg:w-24 flex-shrink-0  rounded-full" />
  <h1 className="text-[20px] sm:text-[24px] md:text-[28px] lg:text-[32px] text-black font-sans font-bold whitespace-nowrap">
    𝐺𝐒 𝑭𝒂𝒔𝒉𝒊𝒐𝒏
  </h1>
</div>
        ...
        <div className='w-[60%] lg:w-[40%] hidden md:flex '>
            <ul className='flex items-center justify-center gap-[25px] text-[white]  '>
